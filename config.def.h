...
static const float rootcolor[] = COLOR(0x252a2bff);   // base00 (UFO-Shadow)
static const float bordercolor[] = COLOR(0x3d3b3aff); // base01 (Cow-Black)
static const float focuscolor[] = COLOR(0xa0b8c8ff);  // base0D (Sky-Blue)
static const float urgentcolor[] = COLOR(0xd2a4a1ff); // base08 (Horizon-Pink)
...
static const MonitorRule monrules[] = {
    ...
    {"eDP-1", 0.5f, 1, 1.15, &layouts[0], WL_OUTPUT_TRANSFORM_NORMAL, -1, -1},
    /* defaults */
...
/* Audio */
static const char *mute_cmd[] = {"/usr/bin/wpctl", "set-mute", "@DEFAULT_SINK@",
                                 "toggle", NULL};
static const char *mutemic_cmd[] = {"/usr/bin/wpctl", "set-mute",
                                    "@DEFAULT_SOURCE@", "toggle", NULL};
static const char *raise_audio_cmd[] = {"/usr/bin/wpctl",
                                        "set-volume",
                                        "@DEFAULT_SINK@",
                                        "5%+",
                                        "--limit",
                                        "1.0",
                                        NULL};
static const char *lower_audio_cmd[] = {"/usr/bin/wpctl", "set-volume",
                                        "@DEFAULT_SINK@", "5%-", NULL};
...
static const Key keys[] = {
    ...
    {MODKEY | WLR_MODIFIER_SHIFT, XKB_KEY_L, spawn,
     SHCMD("swaylock --daemonize -c ~/.config/swaylock/config")},
